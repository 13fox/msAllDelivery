...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'msAllDelivery',
                'description' => 'Default source for files of msAllDelivery',
                ...
                'properties' => array(
                    'basePath' => array(
                        ...
                        'type' => 'textfield',
                        'lexicon' => 'core:source',
                        'value' => 'assets/images/msalldelivery/',
                    ),
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'msalldelivery_source_default'))) {
